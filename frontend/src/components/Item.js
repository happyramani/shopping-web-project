...
function Item({id, name, image, old_price, new_price}) {
  return (
    ...
    <div className='flexCenter'>
        <img src={image} alt="" className='rounded-lg drop-shadow-xl absolute bottom-50' height={211} width={211}/>
    </div>
    <div className='flex flex-col gap-y-3 pt-24'>
        ...
        <div className='flexBetween'>
            ...
            <RiShoppingCart2Line className='p2t h-10 w-10 hover:text-secondary'/>
        </div>
    </div>
   </Link>
  )
