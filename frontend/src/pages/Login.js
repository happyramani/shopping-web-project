...
function Login() {
  ...
  const login = async()=>{
    ...
    let responseData
    await fetch("http://192.168.0.57:4000/login",{
      method: "POST",
      headers: {
  ...
  const signup = async()=>{
    console.log("Login function executed",formData);
    let responseData
    await fetch("http://192.168.0.57:4000/signup",{
      method: "POST",
      headers: {
  ...
  return (
    <section className="max-padd-container flex-col flexCenter pt-32 ">
        ...
        {state === "Sign Up" ?
          <p className="text-black font-bold">
            ...
            <span
              ...
              className="text-secondary underline cursor-pointer"> Login
            </span>
          </p>:
          <p className="text-black font-bold">
